...
time_button.grid(row=0, column=1, padx=10)
...
day_button.grid(row=1, column=0, columnspan=3, sticky='we') # Sticky expands the button with the column level.
...
#Create root window's main loop
root.mainloop()
