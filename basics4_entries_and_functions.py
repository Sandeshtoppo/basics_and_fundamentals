...
def make_label():
    ...
    # print('Hello world')- Prints this in the terminal
...
input_frame.pack(padx=10,pady=10, expand=True)
output_frame.pack(padx=10,pady=(0,10), expand=True)
...
#Run the main window's main loop
root.mainloop()
